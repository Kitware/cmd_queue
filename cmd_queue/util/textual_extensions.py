...
class class_or_instancemethod(classmethod):
    ...
    def __get__(self, instance: Any, type_: Any) -> Any:  # type: ignore
        descr_get = (
            super().__get__ if instance is None else self.__func__.__get__  # type: ignore
        )
    ...
    def run(
        ...
        **kwargs,
        ...
        if isinstance(cls_or_self, type):
            ...
            cls_or_self._run_as_cls(screen=screen, driver=driver, **kwargs)
        else:
            # Running as an instance method
            cls_or_self._run_as_instance(screen=screen, driver=driver, **kwargs)
