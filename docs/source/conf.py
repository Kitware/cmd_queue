...
Notes:
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/cmd-queue/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: cmd_queue
            Set the Repository URL: https://gitlab.kitware.com/computer-vision/cmd_queue
        ...
        Then go to
            ...
            https://gitlab.kitware.com/computer-vision/cmd_queue/hooks
...
modpath = join(dirname(dirname(dirname(__file__))), 'cmd_queue', '__init__.py')
...
# html_logo = '.static/cmd_queue.svg'
# html_favicon = '.static/cmd_queue.ico'
...
man_pages = [
    (master_doc, 'cmd_queue', 'cmd_queue Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cmd_queue', 'cmd_queue Documentation',
     author, 'cmd_queue', 'One line description of project.',
     'Miscellaneous'),
]
